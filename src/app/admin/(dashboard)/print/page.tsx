            ...
            <div className="space-y-3">
              <div>
                ...
                <input
                  ...
                  max={211}
                  value={qrSizeMm}
                  onChange={(e) => setQrSizeMm(Math.max(1, Math.min(211, Number(e.target.value))))}
                  className={`w-full rounded-xl border border-[var(--border)] bg-[var(--surface)] text-[var(--foreground)] px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[var(--primary)] font-semibold ${
                    dir === "rtl" ? "text-right" : "text-left"
                  }`}
                />
                ...
                <div>
                  ...
                  <div className={`mt-2 flex items-center gap-2 ${dir === "rtl" ? "flex-row-reverse" : ""}`}>
                    ...
                    <input
                      ...
                      className="w-full rounded-lg border border-[var(--border)] bg-[var(--surface)] text-[var(--foreground)] px-3 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-[var(--primary)]"
                    />
                  </div>
                </div>
